...
export class InMemoryDatabase implements InMemoryDbService {
  createDb() {
    ...
    const products: Product[] = [
      ...
      { id: 5, name: 'Tablet moderno', description: 'Tablet Nokia', price: 543.12, qty: 18, type: 'Full', details: 'Texto referente ao detalhes do produto...', categoryId: categories[ 4 ].id, category: categories[ 4 ], date: "02/11/2018", picture: '../assets/tablet001.jpg' } as Product
    ];

    const items: Item[] = [
      { id: 1, productId: products[ 0 ].id, product: products[ 0 ] } as Item,
      { id: 2, productId: products[ 2 ].id, product: products[ 2 ] } as Item,
      { id: 3, productId: products[ 4 ].id, product: products[ 4 ] } as Item,
    ];
    ...
    const stores: Store[] = [
      { id: 1, name: 'teste1', description: '', productId: products[ 0 ].id, product: products[ 0 ] } as Store,
      { id: 2, name: 'teste2', description: '', productId: products[ 1 ].id, product: products[ 1 ] } as Store,
      { id: 3, name: 'teste3', description: '', productId: products[ 2 ].id, product: products[ 2 ] } as Store,
      { id: 4, name: 'teste4', description: '', productId: products[ 3 ].id, product: products[ 3 ] } as Store,
      { id: 5, name: 'teste5', description: '', productId: products[ 0 ].id, product: products[ 0 ] } as Store,
      { id: 6, name: 'teste6', description: '', productId: products[ 1 ].id, product: products[ 1 ] } as Store,
      { id: 7, name: 'teste7', description: '', productId: products[ 2 ].id, product: products[ 2 ] } as Store,
      { id: 8, name: 'teste8', description: '', productId: products[ 3 ].id, product: products[ 3 ] } as Store,
      { id: 9, name: 'teste9', description: '', productId: products[ 0 ].id, product: products[ 0 ] } as Store,
      { id: 10, name: 'teste10', description: '', productId: products[ 1 ].id, product: products[ 1 ] } as Store,
      { id: 11, name: 'teste11', description: '', productId: products[ 2 ].id, product: products[ 2 ] } as Store,
      { id: 12, name: 'teste12', description: '', productId: products[ 3 ].id, product: products[ 3 ] } as Store
    ];
    const logins: Login[] = [
    ...
    const carts: Cart[] = [
      { id: 1, name: 'teste carrinho', orderId: orders[ 0 ].id, orders: orders[ 0 ] } as Cart,
      { id: 2, name: 'teste carrinho2', orderId: orders[ 1 ].id, orders: orders[ 1 ] } as Cart,
    ];
